...
public class QuickSort {
    ...
    public static <Item extends Comparable> Queue<Item> quickSort(
        ...
        Queue<Item> qLess = quickSort(less);
        Queue<Item> qGreater = quickSort(greater);
        Queue<Item> qLE = catenate(qLess, equal);
        return catenate(qLE, qGreater);
    }
}
